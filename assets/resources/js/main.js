...
this.querySelector(".js-control-preview-video").play();
this.querySelector(".js-control-preview-video").currentTime=0;
});
coursePreviewModal.addEventListener("hide.bs.modal", function(){
this.querySelector(".js-control-preview-video").pause();
     })
   }
}
coursePreviewVideo();
...
const menu = document.querySelector(".js-header-menu"),
    ...
    //close the menu by clicking out side of it
...
/* color set localstorage*/
function setColor(){
let path = colorStyle.getAttribute("href").split("/");
 path = path.slice(0, path.length-1);
 colorStyle.setAttribute("href", path.join("/") + "/" +localStorage.getItem("color") + ".css");

/*font awesome icon active with active class*/
...
const glassEffectChechbox = document.querySelector(".js-glass-effect"),
glassStyle = document.querySelector(".js-glass-style");
 glassEffectChechbox.addEventListener("click", function(){
 	if(this.checked){
...
if(!glassStyle.hasAttribute("disabled")){
	glassEffectChechbox.checked = true;
